...
export default function Footer() {
  return (
    <footer style={{ backgroundColor: '#282c50' }} className="text-white py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          
          {/* About Section */}
          <div>
            <h3 className="text-xl font-bold mb-4"> The Non-Linear Career Community </h3>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              ...
              {/* YouTube */}
              <a 
                href="https://youtube.com/@chinenyeoguadinma" 
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-gray-300 transition"
              >
        ...
        <div className="border-t border-gray-600 mt-8 pt-8 text-center text-gray-400 text-sm">
          <p>© {new Date().getFullYear()} Chinenye Oguadinma. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
